...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl group/bento transition duration-200 dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-white border justify-between flex flex-col space-y-4 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] min-h-min",
        className
      )}
    >
      {header}
